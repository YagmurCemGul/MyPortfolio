...
export const API_ENDPOINT_URL = process.env.NEXT_PUBLIC_API_ENDPOINT_URL as string;

export const TMDB_V3_API_KEY = process.env.NEXT_PUBLIC_TMDB_V3_API_KEY as string;
